package com.ai.viewpagertab.view;
...
public class TabView extends FrameLayout {
    ...
    private static final int COLOR_SELECTED = Color.parseColor("#FF45C01A");
    ...
    // 方式一：抽取自定义属性，通过xml设置
    // 方式二：直接通过对外开放方法设置；
    public void  setIconAndText(int icon,int iconSelct,String text){
        mIvIcon.setImageResource(icon);
        mIvIconSelected.setImageResource(iconSelct);
